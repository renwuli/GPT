...
class Logger(object):
    def __init__(self, opt, cur_file=None):
        ...
        save_dir = os.path.join(opt.save_dir, time_str)
        ...
        try:
            os.system(f"cp utils.py {log_dir}/")
            os.system(f"cp dataset.py {log_dir}/")
            os.system(f"cp loss.py {log_dir}/")
            os.system(f"cp model.py {log_dir}/")
            os.system(f"cp network.py {log_dir}/")
